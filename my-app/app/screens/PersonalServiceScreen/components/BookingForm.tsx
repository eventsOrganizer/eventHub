...
import { handleConfirm } from './BookingLogic';
...
const BookingForm: React.FC<BookingFormProps> = ({ personalId, userId, availabilityData, onBookingComplete }) => {
  ...
  const onConfirm = async () => {
    ...
    try {
      await handleConfirm(personalId, userId, selectedDate!, startHour, endHour);
