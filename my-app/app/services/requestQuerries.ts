...
const formatRequest = (req: any, type: string): Request => {
  ...
  return {
    ...
    price: type === 'material' ? parseFloat(service?.price) || 0 : undefined,
    priceperhour: (type === 'personal' || type === 'local') ? parseFloat(service?.priceperhour) || 0 : undefined,
    price_per_hour: type === 'material' ? parseFloat(service?.price_per_hour) || 0 : undefined,
