...
interface LocalAvailabilityStepProps {
  formData: any;
  setFormData: (data: any) => void;
}

const LocalAvailabilityStep: React.FC<LocalAvailabilityStepProps> = ({ formData, setFormData }) => {
  ...
  return (
    <Animated.View entering={FadeInRight} exiting={FadeOutLeft} style={styles.container}>
      <Text style={styles.label}>Select Available Dates for Local Service</Text>
      <Calendar
...
export default LocalAvailabilityStep;